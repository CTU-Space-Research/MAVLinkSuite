...
Generated from: ('ctu_sr_illustria_2.xml',)
...
enums["MAV_SYSTEM"] = {}
MAV_SYS_ID_ALL = 0
enums["MAV_SYSTEM"][0] = EnumEntry("MAV_SYS_ID_ALL", """Target id (target_component) used to broadcast messages to all components of the receiving system. Components should attempt to process messages with this component ID and forward to components on any other interfaces. Note: This is not a valid *source* component id for a message.""")
MAV_SYS_ROCKET = 1
enums["MAV_SYSTEM"][1] = EnumEntry("MAV_SYS_ROCKET", """System flight controller component ("autopilot"). Only one autopilot is expected in a particular system.""")
MAV_SYS_GSE = 2
enums["MAV_SYSTEM"][2] = EnumEntry("MAV_SYS_GSE", """System flight controller component ("autopilot"). Only one autopilot is expected in a particular system.""")
MAV_SYS_COMMAND_CENTER = 3
enums["MAV_SYSTEM"][3] = EnumEntry("MAV_SYS_COMMAND_CENTER", """System flight controller component ("autopilot"). Only one autopilot is expected in a particular system.""")
MAV_SYSTEM_ENUM_END = 4
enums["MAV_SYSTEM"][4] = EnumEntry("MAV_SYSTEM_ENUM_END", """""")
...
MAV_COMP_ID_ZORA_RECOVERY = 10
enums["MAV_COMPONENT"][10] = EnumEntry("MAV_COMP_ID_ZORA_RECOVERY", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_ZORA_PRESSURISER = 11
enums["MAV_COMPONENT"][11] = EnumEntry("MAV_COMP_ID_ZORA_PRESSURISER", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_ZORA_ENGINE = 12
enums["MAV_COMPONENT"][12] = EnumEntry("MAV_COMP_ID_ZORA_ENGINE", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_ROCKETLINK_ROCKET = 13
enums["MAV_COMPONENT"][13] = EnumEntry("MAV_COMP_ID_ROCKETLINK_ROCKET", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_WIRELESS_CHARGER = 14
enums["MAV_COMPONENT"][14] = EnumEntry("MAV_COMP_ID_WIRELESS_CHARGER", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_ARMIMG_BOARD = 15
enums["MAV_COMPONENT"][15] = EnumEntry("MAV_COMP_ID_ARMIMG_BOARD", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_GSE_CONTROLLER = 100
enums["MAV_COMPONENT"][100] = EnumEntry("MAV_COMP_ID_GSE_CONTROLLER", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_ROCKETLINK_GROUND = 200
enums["MAV_COMPONENT"][200] = EnumEntry("MAV_COMP_ID_ROCKETLINK_GROUND", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMP_ID_CC_COMPUTER = 201
enums["MAV_COMPONENT"][201] = EnumEntry("MAV_COMP_ID_CC_COMPUTER", """Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network.""")
MAV_COMPONENT_ENUM_END = 202
enums["MAV_COMPONENT"][202] = EnumEntry("MAV_COMPONENT_ENUM_END", """""")
...
enums["MAV_FRAME"][6] = EnumEntry("MAV_FRAME_ENUM_END", """""")
...
# MAV_CMD
enums["MAV_CMD"] = {}
MAV_CMD_SET_LEDS = 100
enums["MAV_CMD"][100] = EnumEntry(
    "MAV_CMD_SET_LEDS",
    """ Setting LEDs in ZORAs
        """,
)
enums["MAV_CMD"][100].param[1] = """ HIGH / LOW """
enums["MAV_CMD"][100].param[2] = """ HIGH / LOW """
enums["MAV_CMD"][100].param[3] = """ HIGH / LOW """
enums["MAV_CMD"][100].param[4] = """ unused """
enums["MAV_CMD"][100].param[5] = """ unused """
enums["MAV_CMD"][100].param[6] = """ unused """
enums["MAV_CMD"][100].param[7] = """ unused """
...
MAVLINK_MSG_ID_ZORA_LED_STATUS = 10
...
class MAVLink_zora_led_status_message(MAVLink_message):
    """
    Testing message
    """
...
# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_zora_led_status_message, "name", mavlink_msg_deprecated_name_property())
...
mavlink_map: Dict[int, Type[MAVLink_message]] = {
    ...
    MAVLINK_MSG_ID_ZORA_LED_STATUS: MAVLink_zora_led_status_message,
